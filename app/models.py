...
class Types(db.Model):
    ...
    @staticmethod
    def insert_types():
        types = {u'要闻', u'军事', u'社会', u'政治', u'体育', u'财经', u'娱乐', u'科技'}
        for t in types:
...
class Conference(db.Model):
    ...
    arrivingtime = db.Column(db.DateTime, index=True)
    conftime = db.Column(db.DateTime, index=True)
...
class AlgoTypes(db.Model):
    ...
    def insert_algotypes():
        algotypes = {u'协调算法', u'svd算法', u'近邻算法', u'隐语义算法'}
        for t in algotypes:
